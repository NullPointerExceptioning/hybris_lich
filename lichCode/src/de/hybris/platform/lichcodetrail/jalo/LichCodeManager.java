 ...
 */
package de.hybris.platform.lichcodetrail.jalo;
...
import de.hybris.platform.lichcodetrail.constants.LichCodeConstants;



/**
 * This is the extension manager of the LichCode extension.
 */
public class LichCodeManager extends GeneratedLichCodeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LichCodeManager.class.getName());
	 ...
	 */
	public static LichCodeManager getInstance()
	{
		return (LichCodeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LichCodeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LichCodeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LichCodeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LichCodeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LichCodeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
